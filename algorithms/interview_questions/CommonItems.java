...
public class CommonItems {
     ...
     * Please note that we have to use {@link Objects#equals(Object, Object)} method
     * so strings would work properly and we are using the
     * equals method in {@link Objects} class so we could accept null inputs without
     * null exception
     * 
    ...
    /**
     * A better solution which includes the use of {@link HashSet}, here we are
     * using {@link HashSet}
     * and NOT {@link HashMap} (key, value data structure) as it was demonstrated in
     * the course as
     * there is no reason to store true for each key and we can check for common
     * objects using the {@link HashSet#contains(Object)} method.
    ...
    /**
     * A better and cleaner solution which includes the use of {@link HashSet}, here
     * we are using {@link HashSet}
     * and NOT {@link HashMap} (key, value data structure) as it was demonstrated in
     * the course as
     * there is no reason to store true for each key and we can check for common
     * objects using the {@link HashSet#contains(Object)} method.
     * This method also takes advantage of features added in Java SE8
     * ({@link Stream})
     * time complexity of O(b) - linear
     * space complexity of O(a) - linear
     * 
